    ...
    <div class="container mt-3" ng-controller="moduleAppController" ng-init="getDetail()">
        ...
        <div class="row px-2 mt-2">
            ...
            <div class="col-4 px-0">
                ...
                <h5 style="text-align: right;"><b>เลขที่ {{detail[0].pvd_no}}</b></h5>
                <h6 style="text-align: right;">วันที่ {{detail[0].pvd_date}}</h6>
            </div>
        </div>
            ...
            <div class="col-12 px-0">
                <table style="border-collapse: collapse; width: 100%;">
                    <tr>
                        ...
                        <td><b>เลขที่ใบลดหนี้</b> {{detail[0].cn_no}}</td>
                    </tr>
                    <tr>
...
<script>
    ...
    app.controller('moduleAppController', function($scope) {
        $scope.getDetail = function() {
            ...
            $scope.year = $scope.detail[0].pvd_date.substring(0,4);
			$scope.month = $scope.detail[0].pvd_date.substring(5,7);
			$scope.day = $scope.detail[0].pvd_date.substring(8,10);
