...
join Supplier on Supplier.supplier_no = RE.supplier_no");
    ...
    public function getPVCs($PVC_No) {
        $sql = $this->prepare("SELECT PVC_Demo.PVC_No,PVC_Demo.Withdraw_Date,PVC_Demo.Withdraw_Name,PVC_Demo.EX_No,PVC_Demo.quotation_name, PVC_Demo.quotation_image FROM `PVC_Demo` WHERE 1");
