...
$sql = $this->prepare("select * from WS_Form where form_no = ?");  
    ...
    public function getPVCs(){
        $sql = $this->prepare("SELECT PVC_Demo.PVC_No,PVC_Demo.Withdraw_Date,PVC_Demo.Withdraw_Name,PVC_Demo.Table_Of_Details,PVC_Demo.quotation_name, PVC_Demo.quotation_image FROM `PVC_Demo` WHERE 1");
        $data =$sql->execute();        
    ...
    }public function getPVCDetail($PVC_No){
        $sql = $this->prepare("SELECT PVC_Demo.PVC_No,PVC_Demo.Withdraw_Date,PVC_Demo.Withdraw_Name,PVC_Demo.Table_Of_Details,PVC_Demo.quotation_name, PVC_Demo.quotation_image FROM `PVC_Demo` WHERE PVC_Demo.PVC_No=?");
    ...
    public function postAdditionDetail($PVC_No){
        $sql = $this->prepare("update PVC_Demo set proof=?,project=?,EX_No=? where PVC_No = ? ");
        $sql->execute([
