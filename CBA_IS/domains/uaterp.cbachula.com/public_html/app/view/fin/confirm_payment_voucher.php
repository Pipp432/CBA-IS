                    ...
                    <table class="table table-hover my-1" ng-show="pvs.length != 0">
                        ...
                        <tr ng-repeat="pv in pvs | unique:'pv_no' | filter:{pv_no:filterPVNo, pv_type:filterPVType}" ng-click="addCpvItem(pv)">
                            ...
                            <td style="text-align: center;">
                                ...
                                <a ng-show = "pv.pv_type == 'Supplier'" href="/acc/confirm_payment_voucher/get_receipt/{{pv.pv_no}}" target="_blank">reciept</a>
                                <a ng-show = "pv.pv_type == 'Supplier'" href="/acc/dashboard/get_PVB_CR/{{pv.pv_no}}" target="_blank">cr</a>
