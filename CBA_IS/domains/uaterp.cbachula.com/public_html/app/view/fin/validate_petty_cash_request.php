...
<body>
    ...
    <div class="container mt-3" ng-controller="moduleAppController">
        ...
        <script>
            addModal('formValidate1', 'confirm เบิกเงินรองจ่าย', 'ยังไม่ได้เพิ่มเลข SOX');
            addModal('formValidate2', 'confirm เบิกเงินรองจ่าย', 'ยังไม่ได้เพิ่มชื่อลูกค้า');
            addModal('formValidate3', 'confirm เบิกเงินรองจ่าย', 'ยังไม่ได้เพิ่มที่อยู่ลูกค้า');
            addModal('formValidate4', 'confirm เบิกเงินรองจ่าย', 'ยังไม่ได้เพิ่มเลขประจำตัวผู้เสียภาษีลูกค้า');
            addModal('formValidate5', 'confirm เบิกเงินรองจ่าย', 'ยังไม่ได้เลือกธนาคาร');
            addModal('formValidate6', 'confirm เบิกเงินรองจ่าย', 'ยังไม่ได้ลงวัน/เวลาการโอน');
            addModal('formValidate7', 'confirm เบิกเงินรองจ่าย', 'ยังไม่ได้อัปรูป');
            addModal('formValidate8', 'confirm เบิกเงินรองจ่าย', 'ยังไม่ได้กรอกหัวกระดาษ');
        </script>
