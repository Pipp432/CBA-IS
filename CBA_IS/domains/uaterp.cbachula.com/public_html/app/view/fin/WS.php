    ...
    <div class="d-flex flex-row " style="padding: 10px 0 0 0;">
        ...
        <div class="dropdown" style="margin:15px 15px;">
            <button class="btn btn-default dropdown-toggle" type="button" id="dropdownMenuMenu" data-toggle="dropdown"
                aria-haspopup="true" aria-expanded="false">เลือกรายการ </button>
            <div class="dropdown-menu" aria-labelledby="dropdownMenuMenu">
                <button class="dropdown-item" type="button" data-toggle="collapse" data-target="#type1" aria-expanded="true" aria-controls="type1">เบิกจ่ายประเภท A</button>
                <button class="dropdown-item" type="button" data-toggle="collapse" data-target="#type3" aria-expanded="false" aria-controls="type3">เบิกจ่ายประเภท C</button>
                <button class="dropdown-item" type="button" data-toggle="collapse" data-target="#type4" aria-expanded="false" aria-controls="type4">อัพโหลดหลักฐานการโอนเงิน (เบิกจ่าย)</button>
                <button class="dropdown-item" type="button" data-toggle="collapse" data-target="#type7" aria-expanded="false" aria-controls="type7">อัพโหลดหลักฐานการโอนเงิน (Supplier)</button>
                <button class="dropdown-item" type="button" data-toggle="collapse" data-target="#type5" aria-expanded="false" aria-controls="type5">อัพโหลดใบสำคัญรับเงิน (for PV ทุกรายการ)</button>
                <button class="dropdown-item" type="button" data-toggle="collapse" data-target="#type6" aria-expanded="false" aria-controls="type6">อัพโหลด IV/CR (ประเภท C)</button>
                    ...
                    <?php 
                        ...
                        <table class="table table-hover my-1">
                            ...
                            foreach($this->status2data as $row){
                                ?>
                               <tr onclick="changeNO('<?php echo $row['form_no']; ?>','<?php echo $row['pv_no']; ?>','<?php echo $row['totalpaid']; ?>')"> 
                                <?php
                    ...
                    <?php 
                        ...
                        <table class="table table-hover my-1">
                            ...
                            foreach($this->pvforreceipt as $row){
                                ?>
                                <tr onclick="setPVNO('<?php echo $row['pv_no']; ?>','<?php echo $row['total_paid']; ?>')"> 
                                 <?php
                                    echo '<td><a href="/file/pv/'.$row['pv_no'].'" target="_blank">'.$row['pv_no'].'</a></th>';
                    ...
                    <div class="row mx-0 mt-2">
                        ...
                        <table class="table table-hover my-1" >
                            ...
                            foreach($this->wstype3data as $row){
                                ?>
                                <tr onclick="settype6('<?php echo $row['form_no']; ?>','<?php echo $row['iv_no']; ?>','<?php echo $row['totalpaid']; ?>')"> 
                                 <?php
                                    echo "<th>".$row['form_no']."</th>"; 
                    ...
                    <?php 
                        ...
                        <table class="table table-hover my-1">
                            ...
                            foreach($this->pvfortranfer as $row){
                                ?>
                                <tr onclick="setPVNO2('<?php echo $row['pv_no']; ?>','<?php echo $row['total_paid']; ?>')"> 
                                 <?php
                                    echo '<td><a href="/file/pv/'.$row['pv_no'].'" target="_blank">'.$row['pv_no'].'</a></th>';
