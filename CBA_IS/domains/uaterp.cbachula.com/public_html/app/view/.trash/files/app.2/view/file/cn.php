    ...
    <script>
        app.controller('app_controller', function($scope) {
            $scope.get_detail = function() {
                $scope.detail = <?php echo $this->cn; ?>[0];
                $scope.project_no = $scope.detail.cn_no.substring(0, 1);
    ...
    <div class="container mt-3" ng-controller="app_controller" ng-init="get_detail()">
        ...
        <div class="row px-2 mt-2">
            ...
            <div class="col-3 px-0">
                ...
                <h5 style="text-align: right;"><b>เลขที่ {{detail.cn_no}}</b></h5>
                <h6 style="text-align: right;">วันที่ {{detail.cn_date}}</h6>
            </div>
        </div>
        
        <h4 class="mt-3 mb-2" style="text-align: center;"><b>ใบลดหนี้ / ใบกำกับภาษี<br><small>Credit Note / Tax Invoice</small></b></h4>
        ...
        <div class="row px-2 mt-2">
            ...
            <div class="col-4 pr-0">
                <table style="border-collapse: collapse; width: 100%;">
                    <tr>
                        <td><b>เลขที่ใบกำกับภาษีเดิม </b> {{detail.iv_no}}</td>
                    </tr>
                    <tr>
                        <td><b>ลงวันที่</b> {{detail.iv_date}}</td>
                    </tr>
                    <tr>
                        <td><b>สาเหตุการลดหนี้</b> {{detail.cn_detail}}</td>
                    </tr>
                </table>
            </div>
        </div>  
        ...
        <div class="row px-2 mt-2">
            <table style="border-collapse: collapse; width: 100%;">
                ...
                <tr>
                    <th colspan="2" style="text-align: left;">จำนวนเงิน (ตัวอักษร) : ศูนย์บาทถ้วน</th>
                    <th colspan="2" style="text-align: right;">ส่วนลด</th>
                    <th style="text-align: right;">({{detail.rg_total_discount | number:2}})</th>
                </tr>
                <tr>
                    <th colspan="2" rowspan="{{detail.rg_type == '1' ? '4' : '5'}}">
                        <div class="row">
                            <div class="col">
                                ลงชื่อ .............................................<br>
                ...
                <tr>
                    ...
                    <th style="text-align: right;">{{0 | number:2}}</th>
                </tr>
