...
<body>
    ...
    <div class="container mt-3" ng-controller="moduleAppController">
		...
		<div class="row mx-0">
			<div class="col-md-4">
				<h2 class="mt-4">Dashboard Stock (CS)  </h2> 
			</div>
            ...
            <div class="card-body">
               ...
               <div class="row mx-0">
                    ...
                    <div class="col-md-5">
                        ...
                        <select class="form-control" ng-model="selectedCS" id="dropdownSupplier">
                ...
                <div class="row mx-0 mt-2"  >
                    ...
                    <table class="table table-hover my-1">
                        ...
                        <tr>
                            ...
                            <th colspan="4">รหัส CS</th>
                            <th colspan="3">วันที่ไป CS</th>
                            <th colspan="3">ผู้ออก CS</th>
                            <th colspan="3">สถานที่</th>
                            <th colspan="3">รหัสสินค้า</th>
                            <th colspan="3">ชื่อสินค้า</th>
                            <th colspan="1">ของออกจากคลัง</th>
                            <th colspan="1">ของเข้าคลัง</th>
							<th colspan="1">ขาย</th>
                        ...
                        <tr ng-repeat="stocks in allstocks">
                            <!-- <td >{{dashboard.file_no}}</td> -->
                        <!-- | filter:{supplier_no:selectedSupplierNo, product_type:selectedProductType}  -->
                            <!-- <a href="/file/cs/mkt/{{cs.cs_no}}" target="_blank"> -->
                            <td colspan="4" ng-click="viewCS(stocks)">{{stocks.file_no}}</td>
                            <td colspan="3">{{stocks.cs_date}}</td>
                            <td colspan="3">{{stocks.employee_id}}</td>
                            <td colspan="3">{{stocks.location_no}}</td>
                            <td colspan="3">{{stocks.product_no}}</td>
                            <td colspan="3">{{stocks.product_name}}</td>
                            <td colspan="1">{{stocks.quantity_in}}</td>
                            <td colspan="1">{{stocks.quantity_out}}</td>
                            <td colspan="1">{{stocks.quantity_left}}</td>
        ...
        <script>
            ...
            // addModal('formValidate3', 'Check Stock (CS)', 'เลือก Supplier ก่อนนะครับผม');

            addModal('formValidate4', 'Check Stock (CS)', 'เลือกประเภทสินค้าก่อนนะครับผม');
...
<script>
    ...
    app.controller('moduleAppController', function($scope, $http, $compile) {
        ...
        $scope.viewCS = function(stocks) {
            //ผิด
            window.open('/file/cs/mkt/' + stocks.file_no);
        }
