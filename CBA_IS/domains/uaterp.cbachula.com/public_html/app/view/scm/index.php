...
<body>
    ...
    <div class="row row-cols-2 row-cols-md-5 mt-2" style="padding: 0;" id="scmRow">
        ...
        <script>addModuleLink('scmRow', '/scm/check_stock', 'slack', 'Check Stock (IRD)');</script>
		...
		<script>addModuleLink('scmRow', '/scm/re_dashboard', 'folder-open-o', 'RE-Dashboard');</script>
