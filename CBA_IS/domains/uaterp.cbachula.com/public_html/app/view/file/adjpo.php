    ...
    <div class="container mt-3" ng-controller="moduleAppController" ng-init="getDetail()">
        ...
        <div class="row px-2 mt-2">
            ...
            <div class="col-4 px-0">
                ...
                <h6 style="text-align: right;">วันที่ {{detail[0].adjpo_date}}</h6>
            </div>
        </div>
        ...
        <div class="row px-2 mt-2">
            <table style="border-collapse: collapse; width: 100%;">
                ...
                <tr>
                    ...
                    <th colspan="1" style="text-align: right;">{{detail[0].adjpo_total_purchase_no_vat | number:2}}</th>
                </tr>
                <tr>
                    <th colspan="2" style="text-align: right;">ภาษีมูลค่าเพิ่ม 7%</th>
                    <th colspan="1" style="text-align: right;">{{detail[0].adjpo_total_purchase_vat | number:2}}</th>
                </tr>
                <tr>
                    <th colspan="2" style="text-align: right;">ราคารวมทั้งสิ้น</th>
                    <th colspan="1" style="text-align: right;">{{detail[0].adjpo_total_purchase_price | number:2}}</th>
                </tr>
            </table>
        </div> 
...
<script>
    ...
    app.controller('moduleAppController', function($scope) {
        $scope.getDetail = function() {
            $scope.detail = <?php echo $this->adjpo; ?>;
            $scope.company = $scope.detail[0].adjpo_no.substring(0,1);
        }
    });
