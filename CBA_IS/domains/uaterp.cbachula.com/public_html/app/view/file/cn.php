        ...
        <div class="row px-2 mt-2">
            ...
            <div class="col-4 pl-2 pr-0">
                <table style="border-collapse: collapse; width: 100%;">
                    ...
                    <tr>
                        <td><b>ลงวันที่</b> {{detail[0].ex_invoice_date}}</td>
                    </tr>
                    <tr>
                ...
                <tr>
                    <th colspan="4" rowspan="5">
                        <div class="row">
                            ...
                            <div class="col-4">
                                __________________________<br>บัญชีผู้ออกเอกสาร<br>วันที่ _____/_____/_____ 
                            </div>
                            <div class="col-4">
                    ...
                    <th colspan="1" style="text-align: right;">{{detail[0].ex_total_sales_no_vat | number:2}}</th>
                </tr>
                <tr>
                    <th colspan="2" style="text-align: right;">มูลค่าที่ถูกต้อง</th>
                    <th colspan="1" style="text-align: right;">{{detail[0].diff_total_sales_no_vat | number:2}}</th>
                </tr>
                <tr>
                    <th colspan="2" style="text-align: right;">ผลต่าง</th>
                    <th colspan="1" style="text-align: right;">{{detail[0].cn_total_sales_no_vat | number:2}}</th>
                </tr>
                <tr>
                    <th colspan="2" style="text-align: right;">ภาษีมูลค่าเพิ่ม 7%</th>
                    <th colspan="1" style="text-align: right;">{{detail[0].cn_total_sales_vat | number:2}}</th>
                </tr>
                <tr>
                    <th colspan="2" style="text-align: right;">จำนวนเงินทั้งสิ้น</th>
                    <th colspan="1" style="text-align: right;">{{detail[0].cn_total_sales_price | number:2}}</th>
                </tr>
            </table>
        </div> 
