...
$dt=$dt -> format('Hi');
	...
	echo "<script>addModuleLink('mktRow', '/mkt/Cancel_Sox', 'shopping-bag', 'Cancel SO/SOX');</script>";
	//echo "<script>addModuleLink('mktRow', '/mkt/Cancel_SO', 'shopping-bag', 'Cancel SO');</script>";
