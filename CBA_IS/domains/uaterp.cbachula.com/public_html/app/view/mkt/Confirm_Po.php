...
<body>
    ...
    <div class="container mt-3" ng-controller="moduleAppController">
        ...
        <h2 class="mt-3">ยืนยันคำสั่งซื้อ / Confirm PO </h2> 
        <!-- for stock and install -->
        ...
        <div class="card shadow p-1 mt-3" style="border:none; border-radius:10px;">
            <div class="card-body">
                <div class="row mx-0">
                    ...
                    <div class="col-md-4">
                        <label for="dropdownType">Product Type</label>
                        <select class="form-control" ng-model="selectedType" id="dropdownType">
                            <option value="">เลือก Product Type</option>
                            <option ng-repeat="product in pos | unique:'product_type' | orderBy:'product_type'" value="{{product.product_type}}">
                ...
                <div class="row mx-0 mt-2">
                    ...
                    <table class="table table-hover my-1" ng-show="pos.length != 0">
                        ...
                        <tr ng-repeat="po in pos | unique:'po_no' | filter:{supplier_no:selectedSupplier, product_type:selectedType, po_no:filterPo}" ng-click="addCiItem(po)">
        ...
        <div class="card shadow p-1 mt-3 mb-3" style="border:none; border-radius:10px;">
            <div class="card-body">
                <div class="row mx-0">
                    <h4 class="my-1">รายละเอียด PO</h4>
                    ...
                    <button type="button" class="btn btn-default btn-block my-1" ng-click="formValidate()">Confirm PO</button>
                </div>
        ...
        <script>
            addModal('formValidate1', 'ยืนยันคำสั่งซื้อ / Confirm PO', 'ยังไม่ได้เพิ่มเลข PO');
        </script>
    ...
    app.controller('moduleAppController', function($scope, $http, $compile) {
        ...
        $scope.formValidate = function() {
            if($scope.ciItems.length===0) {
                ...
                var confirmModal = addConfirmModal('confirmModal', 'ยืนยันคำสั่งซื้อ / Confirm PO', 'ยืนยันคำสั่งซื้อ', 'postCiItems()');
        ...
        $scope.postCiItems = function() {
            ...
            //console.log(JSON.stringify(angular.toJson($scope.ciItems)));
            if(!clicked){
                clicked = true;
                $.post("Confirm_Po/post_ci_items", {
                    post : true,
                    supplierNo : $scope.selectedSupplier,
                    ciItems : JSON.stringify(angular.toJson($scope.ciItems))
                }, function(data) {
                    console.log(data);
                    addModal('successModal', 'ยืนยันคำสั่งซื้อ / Confirm PO ', 'บันทึก ' + data + ' สำเร็จ');
